 ...
 */
export function navMenuFromPluginSidebarItem(item: PluginSidebarNavItem, t: Composer['t']): NavMenu {
 ...
 */
export function filterPluginSidebarNavEntries(items: PluginSidebarNavItem[], t: Composer['t']): PluginNavMenuEntry[] {
